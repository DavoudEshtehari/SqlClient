...
namespace Microsoft.Data.SqlClient
{
    ...
    internal sealed class SqlInternalConnectionTds : SqlInternalConnection, IDisposable
    {
        ...
        private void Login(ServerInfo server, TimeoutTimer timeout, string newPassword, SecureString newSecurePassword, bool tlsFirst)
        {
            ...
            _parser.TdsLogin(login, requestedFeatures, _recoverySessionData, _fedAuthFeatureExtensionData, tlsFirst);
        }
                                ...
                                bool withFailover = false)
        {
            ...
            _parser._physicalStateObj.SniContext = SniContext.Snix_Login;
            this.Login(serverInfo, timeout, newPassword, newSecurePassword, ConnectionOptions.StrictEncryption);
